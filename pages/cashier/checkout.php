...
<body onLoad="document.getElementById('country').focus();">
	<form action="savesales.php" method="post">
		<div id="ac">
			...
			<input type="hidden" name="totalD" value="<?php echo $_GET['totalD']; ?>" />
			...
			<input type="text" size="25" value="" name="caddress" id="country" placeholder="Enter Customer Address" style="width: 268px;" /><br><br>
			<input type="number" size="25" value="" name="ccontact" id="country" placeholder="Enter Customer Contact Number" style="width: 268px;" /><br><br>
