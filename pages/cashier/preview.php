...
<a class = "btn btn-primary" href="javascript:Clickheretoprint()" style="font-size:20px";>Print</a>|<a class = "btn btn-primary" href="sales.php?invoice=&table_number=" style="font-size:20px";>Back</a>
<?php
