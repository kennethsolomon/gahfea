...
<a class="btn btn-primary" href="javascript:Clickheretoprint()" style="font-size:20px" ;>Print</a>|<a class="btn btn-primary" href="sales.php?invoice=&table_number=&discount=0&cdiscount=" style="font-size:20px" ;>Back</a>
<?php
...
<div class="content" id="content">
	<center>
		<div style="margin: 0 auto; padding: 20px; width: 700px; font-weight: normal;">
			<img src="logo.jpg" style="width:70px;height:70px;align:center;margin-bottom:-25px">
			<div style="width: 100%;">
