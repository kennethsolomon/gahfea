...
<body style="background-image: url('../coffee-background.jpg');">
    ...
    <div class="row">
      ...
      <div id="maintable">
        ...
        <form action="incoming.php" method="post" class="form-group">
          ...
          <div class="col-lg-2">
            <label style="color: white">List of Orders:</label>
            <select name="order_list" id="order_list" class="form-control">
              ...
              for ($i = 0; $row = $result->fetch(); $i++) {
              ?>
                <option name="invoice_number" id="invoice_number" value="<?php echo $row['invoice']; ?>" <?php
                                                                                                          if ($row['qty'] == 0) {
                                                                                                            echo 'disabled';
                                                                                                          }
                                                                                                          ?>>
      ...
      <div class="table-responsive col-lg-12" style="background-color:white; border-radius: 20px;">
  ...
  <!-- /#page-wrapper -->
  <div class="container" style="background-color:white; margin-top:10px; border-radius: 20px">
