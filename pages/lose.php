                  ...
                  $dmonth=$_POST["dmonth"];
                      ...
                      echo'</p></center>';
                        ...
                        if(!empty($dmonth) && !empty($dyear)){
                          $sql = "SELECT *, category as cat, sum(amount_lose) as qcount FROM lose where  lmonth = '$dmonth' && lyear = '$dyear' GROUP BY category";
                        } else if (!empty($dmonth)){
                          $sql = "SELECT *, category as cat, sum(amount_lose) as qcount FROM lose where  lmonth = '$dmonth' GROUP BY category";
                        } else if (!empty($dyear)){
                          $sql = "SELECT *, category as cat, sum(amount_lose) as qcount FROM lose where lyear = '$dyear' GROUP BY category";
                  ...
                  <div>
                   <table  border="1" cellpadding="5" width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                      ...
                      if(!empty($dmonth) && !empty($dyear)){
                        $result = $db->prepare("SELECT * FROM lose where lmonth = '$dmonth' && lyear = '$dyear'");
                      } else if (!empty($dmonth)){
                        $result = $db->prepare("SELECT * FROM lose where lmonth = '$dmonth'");
                      } else if (!empty($dyear)){
                        $result = $db->prepare("SELECT * FROM lose where lyear = '$dyear'");
                      } else if (empty($dmonth) && empty($dyear)){
