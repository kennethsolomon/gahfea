                  ...
                  if(isset($_POST["submitdate"]))
                    {
                      ...
                      echo'</p></center>';
                        ...
                        if(!empty($dmonth) && !empty($dyear)){
                          $sql = "SELECT *, type as typ, count(name) as qcount FROM sales where  month = '$dmonth' && year = '$dyear' GROUP BY type";
                        } else if (!empty($dmonth)){
                          $sql = "SELECT *, type as typ, count(name) as qcount FROM sales where  month = '$dmonth' GROUP BY type";
                        } else if (!empty($dyear)){
                          $sql = "SELECT *, type as typ, count(name) as qcount FROM sales where  year = '$dyear' GROUP BY type";
                  ...
                  <div>
                   <table  border="1" cellpadding="5" width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                      ...
                      if(!empty($dmonth) && !empty($dyear)){
                        $result = $db->prepare("SELECT * FROM sales where month = '$dmonth' && year = '$dyear'");
                      } else if (!empty($dmonth)){
                        $result = $db->prepare("SELECT * FROM sales where month = '$dmonth'");
                      } else if (!empty($dyear)){
                        $result = $db->prepare("SELECT * FROM sales where year = '$dyear'");
                      } else if (empty($dmonth) && empty($dyear)){
